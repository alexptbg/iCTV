...
$sqlc = "SELECT * FROM `imdb` WHERE (`Title` LIKE '%".$search."%' OR `imdbID` LIKE '%".$search."%') ORDER BY `id` DESC";
                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title"><em>Search: <strong><?php echo $search; ?></strong></em></h4>
                            </li>
                        </ul>
            ...
            <div class="content-page">
                ...
                <div class="content">
                        <?php
                            ...
                            $sql = "SELECT * FROM `imdb` WHERE (`Title` LIKE '%".$search."%' OR `imdbID` LIKE '%".$search."%') ORDER BY `id` DESC LIMIT $start_from, $num_rec_per_page";
                            $res = mysql_query($sql);
                            confirm_query($res);
                                        ...
                                        <div class=\"profile-info-detail\">
                                            ...
                                            <p class=\"m-t-10 m-b-10\">";
                                                for ($x = 1; $x <= $t['totalSeasons']; $x++) {
													...
													echo "<span class=\"label label-".$seen_class."\">".$x."</span>&nbsp;";
												}
                                                echo "
                                            </p>
    ...
    function ttupdate(tt) {
        $.ajax({
            ...
            success: function(response){
                ...
                var delay = 10;
                setTimeout(function(){ window.location.href = 'search.php?search=<?php echo $search; ?>'; }, delay);
            }
        });
        return false;
    }
